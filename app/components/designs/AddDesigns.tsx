      ...
      <div className="min-h-screen flex items-center justify-center">
        <form className="w-full max-w-2xl p-6 space-y-12 rounded-lg">
            ...
            <div className="border-gray-900/10">
              ...
              <div className="col-span-full mt-5">
                ...
                <p className="mt-3 text-sm leading-6 text-gray-600">
                  Write a brief introduction about the topic.
                </p>
              </div>
          ...
          <div className="">
            <button
              type="submit"
              className="rounded-md w-full bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
            >
              Save
            </button>
          </div>
