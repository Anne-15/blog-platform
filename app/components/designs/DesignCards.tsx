...
const DesignCards = () => {
  const SkeletonOne = () => {
    return (
      <div>
        ...
        <Link href="/Blogs/1">
          <p className="font-bold my-4 max-w-lg text-neutral-200">
  ...
  return (
    <div className="h-screen py-20 mb-20 w-full">
      <div className="text-center py-4 space-y-2">
        <p className="font-bold text-4xl">Product Designs</p>
        <p className="text-sm">
          Product UI/UX designs with all design processes and flows considered
        </p>
        <p className="text-sm italic">Click on each image to view content.</p>
      </div>
